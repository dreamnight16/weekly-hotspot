...
## 分析范例（注意真实性判断和阶级立场的具体写法）

以下是一个合格的 evidence 条目的写法示例：
...
"evidence": [
  {{
    ...
    "sourceName": "新华社",
    "sourceUrl": "...",
    "content": "某省政府发布通知，要求平台企业在 X 月前完成骑手社保登记",
    "authenticity": "真实",
    "aiReason": "政府文件可直接查证，新华社引用了文件编号和具体条款，未发现与该文件矛盾的其他信源",
    "classBias": "无产阶级立场"
  }},
  {{
    "id": "ev-{idx}-2",
    ...
    "sourceName": "抖音",
    "sourceUrl": null,
    "content": "多名骑手发视频称社保登记后实际到手收入下降，平台提高了配送抽成比例",
    "authenticity": "存疑",
    "aiReason": "骑手自述反映一线情况，但缺乏系统数据支持，且平台尚未回应。此类自媒体报道需交叉验证",
    "classBias": "无产阶级立场"
  }}
],
...
"edges": [
  {{
    ...
    "to": "tl-{idx}-2",
    "type": "矛盾",
    "description": "政府社保政策（tl-1）本意是改善骑手待遇，但平台通过提高抽成（tl-2）将成本转嫁回骑手，形成政策意图与执行效果之间的对立。这不是简单的'上有政策下有对策'，而是平台利用其在配送市场中的资本权力，将政府规制的外部压力转化为对骑手的内部剥削"
  }}
],

dialecticalSummary 写法示例：
"dialecticalSummary": "政府通过行政手段推动平台改善劳动条件，但资本通过调整抽成机制将成本转嫁，实际效果变成了'骑手为社保买单'。矛盾的核心不在政策本身，而在平台对配送定价权的垄断。如果定价机制不改变，类似政策都将被资本的转嫁能力消解。"

确保你的输出达到上述范例的具体性——证据判断有理由、阶级立场有依据、关系描述涉及物质利益对抗。
